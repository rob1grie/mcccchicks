...
<html>
<head>
<title>Chicks - a Mustang Creek Community Church Ministry - Forney, TX - Events</title>
			...
			<tr>
				<td width="100%" align="center">
                                    ...
                                    <table width="100%" border="0" style="line-height: 20px">
                                        <tr>
                                            <td colspan="3" align="center" class="form_label">
                                                Chicks 'Legacy' Conference<br>
                                                May 16-17, 2014</td>
                                        </tr>
                                        <tr><td colspan="3">&nbsp;</td></tr>
                                      <tr>
                                            <td colspan="3" align="center">
                                            <p class="lineheight-24">Our success in life is not measured by how much<br>
                                              we accumulate to leave others when we die.</p>
                                          <p class="lineheight-24">It is measured by the lives we influenced along the way!</p>
                                          <p class="lineheight-24">It is not our dying that establishes our legacy.<br>
                                            It is formed in our living.</p>
                                          <p class="lineheight-24">Join us!</p></td>
                                        </tr>
                                        <tr><td colspan="3">&nbsp;</td></tr>
                                      <tr>
                                            <td width="25%" align="center">&nbsp;</td>
                                            <td width="50%" align="center">
                                                <a href="conference_blurb.php" class="highlightedbutton">Conference Info</a>
                                          </td>
                                            <td width="25%">&nbsp;</td>
                                        </tr>
                                    </table>

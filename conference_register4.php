		...
		<table align="center" width="95%" border="0">
			...
			<tr>
				<td colspan="3" class="body_message" align="center">
					Thank you for providing your registration information.<br/><br/>
					<span class="highlightedmedium"><input type="checkbox" name="payfee" value="PayFee" />
					Please check here if you would like to increase your<br/>payment to 
					<?php echo $totalWithFee; ?> in order to cover the Paypal fee.</span><br/></br>
					When you click the Continue button below<br/>
					an email will be sent to the Registration office<br/>containing all of your registration information.<br/><br/>
					You will then be directed to the Paypal web site,<br/>where you can provide payment for your registration.<br/><br/>
					Please look carefully at the Paypal form<br/>and notice the link enabling you to<br/>
					pay your registration fee with a credit or debit card.<br/>
					<span style="text-decoration:underline">You will not need a Paypal account.</span><br/><br/>
			...
			<tr>
				<td colspan="3">
					<table width="100%">
						<tr>
							<td width="50%" align="center"><input type="button" value="           Cancel           " onClick="confirm_cancel()" /></td>
							<td width="50%" align="center"><input type="submit" value="     Continue to Paypal     " name="submit" /></td>
						</tr>
					</table>
				</td>
			</tr>

<?php
	...
	$m = $_GET['m'];
	if(isset($m) && ($m=='late'))
		header("Location:conference_toolate.php");
	else
		$mode = '';
?>
<html>
...
<tr>
	...
	<td width="590" valign="middle" align="center">
		<img src="images/conference_schedule.jpg" name="center_content" width="576" height="514" border="0" usemap="#graphicmap" />	
		<map name="graphicmap">
			<area shape="rect" coords="230,458,345,508" href="conference_register1.php" />
			<area shape="rect" coords="62,458,177,507" href="conference_blurb.php" />
			<area shape="rect" coords="399,458,513,508" href="conference_hotel.php" />
		</map>
	</td>
	<td width="214" align="center"><script language="JavaScript" src="slideshow_home.js"></script></td>
</tr>

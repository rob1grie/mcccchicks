<?php 	// Check for URL argument m=late, flagging that no conference was found with rate within current date
	if(isset($_GET['m']) && ($_GET['m']=='late')) {	  $mode = 'late';
	}	else {
		$mode = '';	}
?><html>
  <head>
        ...
        <table width="1026px" align="center" cellpadding="0px">
          <tbody>
            ...
            <tr>
              ...
              <td valign="middle" width="590" align="center"> <img src="images/conference_blurb.jpg"
                  name="center_content" usemap="#graphicmap" border="0" height="520"
                  width="573"> <map name="graphicmap">
                  <area shape="rect" coords="160,480,323,512" href="conference_schedule.php">
                  <area shape="rect" coords="76,414,239,460" href="conference_register1.php">
                </map>
              </td>
